...
Karena proyek ini disimulasikan menggunakan [Wokwi](https://wokwi.com/), Anda tidak perlu menginstal perangkat lunak fisik apa pun (Arduino IDE tidak diwajibkan). Ikuti langkah-langkah berikut:

1.  Buka platform Wokwi di browser Anda.
...
6.  **Cara interaksi:**
    * Klik tombol **RESET** untuk mengembalikan LED ke posisi mati (0).
    * Klik tombol **UP / DOWN** untuk membalikkan arah *counting*.
